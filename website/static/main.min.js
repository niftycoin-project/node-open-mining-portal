...
function y(b){var a='<div class="coinInfoData">Algorithm:</div>',c='<div class="coinInfoData">'+b.algo+"</div>",h;for(h in b.ports){var e="Low";switch(b.ports[h].diff){case 32:e="Med";break;case 256:e="High"}a+='<div class="coinInfoData">URL <span class="coinInfoSubtle">('+e+")</span>:</div>";c+='<div class="coinInfoData">stratum+tcp://'+b.host+":"+h+"</div>"}b.coin?$("#coinInfoUsername").text("Your "+b.coin.name.replace(/(^([a-zA-Zp{M}]))|([ -][a-zA-Zp{M}])/g,function(a){return a.toUpperCase()})+
